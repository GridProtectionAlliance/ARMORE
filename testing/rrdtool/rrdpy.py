...
"""
while(1):
    rrdtool.graph('blah.png','DEF:load=/var/lib/collectd/rrd/ARMORETEST/load/load.rrd:shortterm:AVERAGE', 'LINE2:load#FF0000')
    rrdtool.graph('zah.png','DEF:load=/var/lib/collectd/rrd/ARMORETEST/interface-eth0/if_packets.rrd:rx:AVERAGE', 'LINE2:load#FF0000')
    time.sleep(2)
