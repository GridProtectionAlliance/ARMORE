...
rrdFlot.prototype.createHTML = function() {
  ...
  cellDScb.style.verticalAlign="top";
...
/*
  ...
  */
  ...
  cellScale.colSpan = "3";
  cellScale.style.horizontalAlign="left";
  ...
  var rowScaleReset=external_table.insertRow(2);
  var cellScaleReset=rowScaleReset.insertCell(-1);
  cellScaleReset.style.padding = "20px 0px 20px 23px";
  cellScaleReset.colSpan = "3";
  cellScaleReset.style.horizontalAlign="left";
  cellScaleReset.style.verticalAlign="middle";
...
rrdFlot.prototype.populateRes = function() {
  ...
  for (var i=0; i<nrRRAs; i++) {
    ...
    var rra_label= rra.getCFName() + ": " + rfs_format_time(step)+" ("+rfs_format_time(period)+" total)";
...
rrdFlotMatrix.prototype.createHTML = function() {
  ...
  if(this.rrdflot_defaults.graph_width!=null) {
     elGraph.style.width=this.rrdflot_defaults.graph_width;
  } else {elGraph.style.width="800px";}
  if(this.rrdflot_defaults.graph_height!=null) {
     elGraph.style.height=this.rrdflot_defaults.graph_height;
  } else {elGraph.style.height="300px";}
  elGraph.id=this.graph_id;
...
/*
  ...
  */
  ...
  var rowScaleReset=external_table.insertRow(-1);
