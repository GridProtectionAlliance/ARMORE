...
class DdsEngine : public MiddlewareEngine
{
public:
    // Constructors
    DdsEngine(BufferReceivedCallback callback, bool serverMode, bool securityEnabled, int inactiveClientTimeout, bool verboseOutput);
    ~DdsEngine();
